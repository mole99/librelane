...
# Make fake I/O sites
if { [info exists ::env(PAD_FAKE_IO_SITE_WIDTH)] || [info exists ::env(PAD_FAKE_IO_SITE_HEIGHT)] } {
    make_fake_io_site -name $::env(PAD_IO_SITE_NAME) -width $::env(PAD_FAKE_IO_SITE_WIDTH) -height $::env(PAD_FAKE_IO_SITE_HEIGHT)
}
